...
The shared rule is
[Call the shared link checker instead of copying it](https://github.com/iglootools/common-guidelines/blob/main/guidelines/project-setup.md#call-the-shared-link-checker-instead-of-copying-it)
